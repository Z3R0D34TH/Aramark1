...
namespace Aramark1
{
    public partial class Menu : System.Web.UI.Page
    {
        ...
        {
            conn.Open();
            SqlCommand cmd = new SqlCommand("SELECT * FROM dbo.[Order]", conn);
        ...
        protected void GridView1_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            ...
            conn.Open();
            SqlCommand cmd = new SqlCommand("delete FROM Order where O='" + Convert.ToInt32(GridView1.DataKeys[e.RowIndex].Value.ToString()) + "'", conn);
            cmd.ExecuteNonQuery();
            conn.Close();
            gvbind();
        }
