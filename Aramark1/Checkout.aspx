...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <br />
            Your cart:<br />
            <asp:GridView ID="GridView" runat="server" AutoGenerateColumns="False" DataKeyNames="OrderID" OnRowDeleting="GridView1_RowDeleting" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" AutoGenerateDeleteButton="True" AutoGenerateSelectButton="True">  
                    <Columns>  
            ...
            <br />
            <asp:Label ID="Errorspaying" runat="server" Font-Bold="True" Font-Size="Large" ForeColor="#990000"></asp:Label>
            <br />
